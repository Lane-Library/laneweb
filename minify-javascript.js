...
const bundles = [
    {
        ...
        inputs: [
            ...
            'src/main/javascript/lane-bookmarklet.js',
            'src/main/javascript/lane-persistent-login.js',
            'src/main/javascript/search-indicator.js',
            'src/main/javascript/lane-bassett.js',
            ...
            'src/main/javascript/lane-tracking.js',
            'src/main/javascript/lane-google-GA4.js',
            'src/main/javascript/lane-popup.js',
            'src/main/javascript/lane-tooltips.js',
            'src/main/javascript/lane-spellcheck.js',
