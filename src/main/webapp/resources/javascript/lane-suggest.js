    ...
    var suggestElms = Y.all('.laneSuggest'), i,
        ...
        init = function (input) {
            ...
            input.ac.on("ac:show", function () {
                if (!acWidget.visible) acWidget.render();
            }, acWidget);
...
/*YUI().use('yui2-yahoo','yui2-dom','yui2-event','yui2-autocomplete','yui2-datasource','yui2-connection','node', function(Y){
        var suggestElms = Y.all('.laneSuggest'), i,
            acWidgets = [],
            ...
            initialize = function(input) {
                ...
                searchSourceElm = searchFieldset.one('#searchSource');
...
//
//YUI().use('gallery-ac-widget', 'datasource', function (Y) {
//    var suggestElms = Y.all('.laneSuggest'), i;
//    for (i = 0; i < suggestElms.size(); i++) {
//    
//        new Y.ACWidget({
//            ac: suggestElms.item(i).plug(Y.Plugin.ACPlugin, {
//                queryTemplate: function(q) {
//                    return "q=" +
//                    encodeURIComponent(q.replace(/(["\\])/g, '\\$1'));
//                },
//                dataSource: new Y.DataSource.IO({
//                    source: "/././apps/suggest/json?"
//                }).plug(Y.Plugin.DataSourceJSONSchema, {
//                    schema: {
//                        resultListLocator: "suggest"
//                    }
//                })
//            }).ac
//        }).render();
