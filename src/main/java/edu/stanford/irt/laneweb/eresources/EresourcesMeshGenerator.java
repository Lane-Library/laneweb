...
public class EresourcesMeshGenerator extends AbstractEresourcesGenerator {
    ...
    private static final String MESH_SQL_1 = "SELECT ERESOURCE.ERESOURCE_ID, VERSION.VERSION_ID, LINK_ID, TITLE, PUBLISHER,\n"
            + "HOLDINGS, DATES, DESCRIPTION, PROXY, LABEL, URL, INSTRUCTION,\n"
            + "NLSSORT(TITLE,'NLS_SORT=GENERIC_BASELETTER') AS SORT_TITLE\n"
            + "FROM ERESOURCE, VERSION, LINK, MESH";

    private static final String MESH_SQL_2 = ", TYPE";
    ...
    private static final String MESH_SQL_4 = "AND ERESOURCE.ERESOURCE_ID = MESH.ERESOURCE_ID\n"
            + "AND MESH.TERM = '";

    private static final String MESH_SQL_5 = "AND ERESOURCE.ERESOURCE_ID = TYPE.ERESOURCE_ID\n"
            + "AND TYPE.TYPE = '";

    private static final String MESH_SQL_8 = "UNION SELECT ERESOURCE.ERESOURCE_ID, VERSION.VERSION_ID, LINK_ID, PREFERRED_TITLE AS TITLE, PUBLISHER,\n"
            + "HOLDINGS, DATES, DESCRIPTION, PROXY, LABEL, URL, INSTRUCTION,\n"
