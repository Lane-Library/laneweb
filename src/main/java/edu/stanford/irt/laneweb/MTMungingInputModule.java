 ...
 * does so that the category label resolves to the correct category archive document.
 * it also is useful in translating the formerly used _id form for faq ids to 
 * the id without the preceeding underscore.
 * @author ceyates
 *
 */
