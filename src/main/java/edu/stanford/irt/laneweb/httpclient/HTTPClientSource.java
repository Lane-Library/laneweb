 ...
 * href="http://jakarta.apache.org/commons/httpclient/">HttpClient</a> project.
 * 
...
public class HTTPClientSource extends AbstractLogEnabled implements ModifiableSource, Initializable, Parameterizable {
    ...
    /**
     * Method to discover what kind of request is being made from the parameters
     * map passed in to this Source's constructor.
     * 
     * @return the method type, or if no method type can be found, HTTP GET is
     *         assumed.
     */
    ...
    /**
     * Helper method to create the required {@link HttpMethod} object based on
     * parameters passed to this {@link HTTPClientSource} object.
     * 
     ...
     * 
     * @param uri
     *            URI to upload <code>uploadFile</code> to
     * @param uploadFile
     *            {@link File} to be uploaded
    ...
    /**
     * Recycles this {@link HTTPClientSource} object so that it may be reused to
    ...
    /**
     * Internal class which extends {@link FileOutputStream} to automatically
     * upload the data written to it, upon a {@link #close} operation.
     */
    private class WrappedFileOutputStream extends FileOutputStream {
        ...
        /**
         * Constructor, creates a new {@link WrappedFileOutputStream} instance.
         * 
         * @param file
        ...
        /**
         * According to RFC2616 (HTTP 1.1) valid responses for a HTTP PUT are
         * 201 (Created), 200 (OK), and 204 (No Content).
         * 
         * @param response
    ...
    /**
     * According to RFC2616 (HTTP 1.1) valid responses for a HTTP DELETE are 200
     * (OK), 202 (Accepted) and 204 (No Content).
     * 
     * @param response
     *            response code from the HTTP PUT
     * @return true if upload was successful, false otherwise.
    ...
    /**
     * Method to determine whether writing to the supplied OutputStream (which
     * must be that returned from {@link #getOutputStream()}) can be cancelled
     * 
     * @return true if writing to the stream can be cancelled, false otherwise
     */
