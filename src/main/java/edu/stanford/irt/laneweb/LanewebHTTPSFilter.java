/*
 * Created on Aug 5, 2004 To change the template for this generated file go to Window - Preferences - Java - Code
...
public class LanewebHTTPSFilter implements Filter {
    ...
    public void doFilter(final ServletRequest request, final ServletResponse response, final FilterChain chain)
        ...
        String url =
                queryString == null ? req.getRequestURL().toString() : req.getRequestURL().append('?').append(
