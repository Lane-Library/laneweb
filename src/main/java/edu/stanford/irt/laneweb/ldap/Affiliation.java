 ...
 * 
 * @see <a href="https://www.stanford.edu/dept/as/mais/integration/data/data_affiliation_types.html">LDAP
 * @see group for lane     https://medwiki.stanford.edu/display/lane/Proxy+server+documentation
 *      
...
public enum Affiliation {
  ...
  Affiliation(String ldapAffiliateString, String display) {
    this(ldapAffiliateString, display, true);
  }

  Affiliation(String ldapAffiliateString, String display, boolean active) {
  ...
  public static final Affiliation getAffiliation(String ldapString) {
