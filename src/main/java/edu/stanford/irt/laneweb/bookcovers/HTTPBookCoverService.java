...
public class HTTPBookCoverService implements BookCoverService {
    ...
    public HTTPBookCoverService(final ObjectMapper objectMapper, final URI bookCoverServiceURI,
