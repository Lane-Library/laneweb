...
public final class IPGroup implements Serializable {
    ...
    static {
        ...
        ROOT.addSubrange(new CIDRRange("96.47.52.249/32", SHC));
        ROOT.addSubrange(new CIDRRange("96.47.52.250/32", SHC));
        ROOT.addSubrange(new CIDRRange("96.47.58.249/32", SHC));
        ROOT.addSubrange(new CIDRRange("96.47.58.250/32", SHC));
