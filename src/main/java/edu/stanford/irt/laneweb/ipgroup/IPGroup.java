...
public final class IPGroup implements Serializable {
    ...
    static {
        ...
        ROOT.addSubrange(new CIDRRange("171.65.82.20/32", STAFF));
        ROOT.addSubrange(new CIDRRange("171.65.82.24/32", STAFF));
        ROOT.addSubrange(new CIDRRange("171.65.82.42/32", STAFF));
        ROOT.addSubrange(new CIDRRange("171.65.82.61/32", STAFF));
        ...
        ROOT.addSubrange(new CIDRRange("171.65.82.105/32", STAFF));
        ROOT.addSubrange(new CIDRRange("171.65.82.109/32", STAFF));
        ROOT.addSubrange(new CIDRRange("171.65.82.112/32", STAFF));
        ROOT.addSubrange(new CIDRRange("171.65.82.133/32", STAFF));
        ...
        ROOT.addSubrange(new CIDRRange("171.65.82.204/32", STAFF));
        ...
        ROOT.addSubrange(new CIDRRange("171.65.83.32/32", STAFF));
        ROOT.addSubrange(new CIDRRange("171.65.83.45/32", STAFF));
        ...
        ROOT.addSubrange(new CIDRRange("171.65.83.160/32", STAFF));
        ...
        ROOT.addSubrange(new CIDRRange("171.65.83.208/32", STAFF));
        ROOT.addSubrange(new CIDRRange("171.65.83.209/32", STAFF));
        ROOT.addSubrange(new CIDRRange("171.65.83.212/32", STAFF));
        ROOT.addSubrange(new CIDRRange("171.65.83.213/32", STAFF));
        ROOT.addSubrange(new CIDRRange("171.65.83.214/32", STAFF));
