...
public class LaneCrmController {
    ...
    public String sendEmail(final Model model, final RedirectAttributes atts) throws JacksonException {
    ...
    @ModelAttribute
    protected void getParameters(final HttpServletRequest request, final Model model) throws JacksonException {
