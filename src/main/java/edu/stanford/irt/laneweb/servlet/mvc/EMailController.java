...
public class EMailController {
  ...
  public EMailController(@Qualifier("edu.stanford.irt.laneweb.servlet.binding.DataBinder/email") final DataBinder dataBinder, final EMailSender sender, final SpamService spamService) {
  ...
  public String formSubmitAskUs(final Model model, @RequestParam("attachment") final MultipartFile file, final RedirectAttributes atts) throws IllegalStateException, IOException {
  ...
  public String formSubmitEJP(final Model model, @RequestParam("attachment") final MultipartFile file, final RedirectAttributes atts) throws IllegalStateException, IOException {
    Map<String, Object> map = model.asMap();
