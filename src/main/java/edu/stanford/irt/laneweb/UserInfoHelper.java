...
public class UserInfoHelper {
    ...
    public String getSunetId(Request request) throws InvalidKeyException, IllegalBlockSizeException, BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeySpecException, UnsupportedEncodingException, DecoderException
    {
	if(cryptor == null)
	...
	String decryptedSecurity = cryptor.decrypt(securityCookie.getValue());
	String decryptedSunetId = cryptor.decrypt(sunetIdCookie.getValue());
	String decryptedDate =  cryptor.decrypt(dateCookie.getValue());
