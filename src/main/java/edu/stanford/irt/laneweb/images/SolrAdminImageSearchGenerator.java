...
public class SolrAdminImageSearchGenerator extends SolrImageSearchGenerator {
    ...
    protected Page<Image> getPage(final String query) {
        ...
        if (this.limit == null || "".equals(this.limit)) {
            ...
            LocalDate date = LocalDate.parse(this.limit, formatter);
            result = this.service.adminFindAllFilterOnCopyrightAndWebsiteIdAndDate(query, this.copyright, this.resourceId, date, page);
        }
        return result;
    }
}
