...
public class VoyagerLoginImpl extends AbstractLogEnabled implements
    ...
    public String getVoyagerURL(final LDAPPerson person,
            final String pid, final String queryString) {
    ...
    public void service(ServiceManager manager) throws ServiceException {
        ServiceSelector selector = (ServiceSelector) manager.lookup(DataSourceComponent.ROLE);
