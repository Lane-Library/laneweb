...
public class LibappsServiceConfiguration {
    ...
    public URI guideServiceURI(@Value("${edu.stanford.irt.laneweb.libguide-service.scheme}") String scheme,
    ...
    public URI guideApiServiceURI(@Value("${edu.stanford.irt.laneweb.libguide-api-service.scheme}") String scheme,
