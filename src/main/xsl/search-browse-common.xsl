            ...
            <div class="hldgsContainer no-bookmarking">
                ...
                <xsl:choose>
                    <xsl:when test="$itemsAvailableButMaybeNotRequestable">
                        <span class="hldgsHeader available"><i class="fa-light fa-book"></i> <xsl:value-of select="f:itemTypeLabel($eresource)"/> Access</span>
                        <span class="hldgsTrigger"/>
                    ...
                    <xsl:otherwise>
                        <span class="hldgsHeader"><i class="fa-light fa-book"></i> <xsl:value-of select="f:itemTypeLabel($eresource)"/> Status unknown</span>
                        <span class="hldgsTrigger"/>
                    </xsl:otherwise>
                </xsl:choose>
                <table class="hide-empty-columns">
