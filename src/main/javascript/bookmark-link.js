    ...
    if (Model.get(Model.BOOKMARKING) === "rw") {
        ...
        Y.extend(BookmarkLink, Y.Base, {
            ...
            initializer: function () {
                ...
                Y.delegate("mouseover", this._handleTargetMouseover, "section.no-search-content", "a", this);
                Y.delegate("mouseout", this._handleTargetMouseout, "section.no-search-content", "a", this);
