...
public class CMERedirectActionTest {
    ...
    public void testAct() {
        ...
        expect(parameters.getParameter("emrid", null)).andReturn("nobody");
        replay(parameters);
        assertEquals("http://laneproxy.stanford.edu/login?url=http://www.uptodate.com/online/content/search.do?unid=nobody&srcsys=epic90710&eiv=2.1.0", this.action.act(null, null, null, null, parameters).get("cme-redirect"));
        verify(parameters);
    }
