...
public class EMailControllerTest {
    ...
    public void testFormSubmitAskUsContentTypeError() throws IllegalStateException, IOException {
        ...
        replay(this.headerBinder, this.remoteIPBinder, this.sender, this.atts, this.model, this.map,
                this.multipartFile);
        assertEquals("redirect:/error_upload_file.html",
                this.controller.formSubmitAskUs(this.model, this.multipartFile, this.atts));
        verify(this.headerBinder, this.remoteIPBinder, this.sender, this.atts, this.model, this.map,
                this.multipartFile);
    }
    ...
    @Test
    public void testFormSubmitAskUsAttachment() throws IllegalStateException, IOException {
    ...
    @Test
    public void testJsonSubmitAskUswithAttachmentNotImageContentType() {
        String image = "data:test/gif;base64,";
        expect(this.model.asMap()).andReturn(this.map);
        this.map.putAll(this.map);
        expect(this.map.get("subject")).andReturn("subject");
        expect(this.map.get("name")).andReturn("name");
        expect(this.map.remove("attachment")).andReturn(image);
        expect(this.map.remove("attachmentFileName")).andReturn("attachmentFileName");
        expect(this.map.put("subject", "subject (name)")).andReturn(null);
        expect(this.map.put("recipient", "LaneAskUs@stanford.edu")).andReturn(null);
        expect(this.map.put("attachment",
                "Attachment deleted for security raison, use your email client to see the attachment")).andReturn(null);
        this.sender.sendEmail(this.map, null);
        replay(this.headerBinder, this.remoteIPBinder, this.sender, this.atts, this.model, this.map);
        this.controller.jsonSubmitAskUs(this.map, this.model);
        verify(this.headerBinder, this.remoteIPBinder, this.sender, this.atts, this.model, this.map);
    ...
    @Test
    public void testJsonSubmitAskUswithAttachmenttooLarge() {
        StringBuilder image = new StringBuilder(
                "data:image/gif;base64,");
        for (int i = 0; i < 3000; i++) {
            image.append(
        ...
        expect(this.map.get("subject")).andReturn("subject");
        expect(this.map.get("name")).andReturn("name");
        expect(this.map.remove("attachment")).andReturn(image.toString());
        expect(this.map.remove("attachmentFileName")).andReturn("attachmentFileName");
        expect(this.map.put("subject", "subject (name)")).andReturn(null);
        expect(this.map.put("recipient", "LaneAskUs@stanford.edu")).andReturn(null);
        this.sender.sendEmail(this.map, null);
    ...
    @Test
    public void testJsonSubmitAskUswithAttachment() {
        String image = "data:image/gif;base64,";
    ...
    public void testRedirectToIndex() throws IllegalStateException, IOException {
        expect(this.multipartFile.isEmpty()).andReturn(new Boolean(true)).times(2);
        expect(this.model.asMap()).andReturn(this.map);
        expect(this.map.get("subject")).andReturn("subject");
        expect(this.map.get("name")).andReturn("name");
        expect(this.map.put("subject", "subject (name)")).andReturn(null);
        ...
        replay(this.headerBinder, this.remoteIPBinder, this.sender, this.atts, this.model, this.map,
                this.multipartFile);
        assertEquals("redirect:/index.html",
                this.controller.formSubmitAskUs(this.model, this.multipartFile, this.atts));
        verify(this.headerBinder, this.remoteIPBinder, this.sender, this.atts, this.model, this.map,
                this.multipartFile);
    }
