...
public class RedirectProcessorTest {
    ...
    public void testHandleRequestRedirectClasses() throws ServletException, IOException {
        this.redirectProcessor.setRedirectMap(Collections.singletonMap("(.*)/classes/index.html", "$1/services/workshops/laneclasses.html"));
        assertEquals("/services/workshops/laneclasses.html", this.redirectProcessor.getRedirectURL("/classes/index.html"));
    }
    ...
    public void testHandleRequestRedirectClinician() throws ServletException, IOException {
        ...
        assertEquals("/foo/bar/portals/clinical.html", this.redirectProcessor.getRedirectURL("/foo/bar/clinician/index.html"));
    }
}
