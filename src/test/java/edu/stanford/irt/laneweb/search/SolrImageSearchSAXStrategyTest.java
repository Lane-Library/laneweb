...
public class SolrImageSearchSAXStrategyTest {
    ...
    public void testToSAXIDWithoutSlash() throws IOException {
        ...
        expect(this.page.getNumberOfElements()).andReturn(1);
        expect(this.page.getTotalElements()).andReturn(52L);
        ...
        this.strategy.toSAX(this.page, this.xmlConsumer);
    }
    ...
    public void testToSAXBassett() throws IOException {
        ...
        replay(this.page, this.image);
        this.strategy.toSAX(this.page, this.xmlConsumer);
        assertEquals(this.xmlConsumer.getExpectedResult(this, "SolrImageSearchSAXStrategyTest-testToSAXBassett.xml"),
                this.xmlConsumer.getStringValue());
        verify(this.page, this.image);
    }
    ...
    public void testToSAXPubMed() throws IOException {
        ...
        replay(this.page, this.image);
        this.strategy.toSAX(this.page, this.xmlConsumer);
        assertEquals(this.xmlConsumer.getExpectedResult(this, "SolrImageSearchSAXStrategyTest-testToSAXPubMed.xml"),
                this.xmlConsumer.getStringValue());
        verify(this.page, this.image);
    }
    ...
    public void testToSAXLongTitle() throws IOException {
        ...
        expect(this.page.getTotalElements()).andReturn(52L);
        expect(this.image.getId()).andReturn("id/andSlash").times(2);
        expect(this.image.getTitle()).andReturn("0123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789");
        expect(this.image.getPageUrl()).andReturn("pageUrl");
        expect(this.image.getThumbnailSrc()).andReturn("thumbnailSrc");
        expect(this.image.getSrc()).andReturn("src").times(2);
        expect(this.image.getCopyrightValue()).andReturn(0);
    ...
    //FIXME: id checked for null in one place but not another
    ...
    public void testToSAXStartDocumentThrowsException() throws SAXException {
        ...
        replay(c, this.page);
        this.strategy.toSAX(this.page, c);
    }
    
    //FIXME: don't need to catch SAXException twice in the SAXStrategy
    @Test(expected = LanewebException.class)
