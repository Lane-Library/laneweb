...
public class LocationModifierTest {
    ...
    public void testModifyLocationDoubleSlash() throws URISyntaxException {
        assertEquals(new URI("cocoon://content/biomed-resources/software.html"),
