...
public class SitemapSourceLocationModifierTest {
    ...
    public void testModifyLocationDoubleSlash() {
        assertEquals("content:/biomed-resources/software.html", this.locationModifier.modify("cocoon://content/biomed-resources/software.html"));
    }
    ...
    @Test
    public void testRss() {
        assertEquals("rss:/biomed-resources/browse/type/ej", this.locationModifier.modify("cocoon://rss/biomed-resources/browse/type/ej"));
    }
    
    @Test
    public void testNcbiRss2HTML() {
        assertEquals("content:/ncbi-rss2html-brief/foo/bar", this.locationModifier.modify("cocoon://rss/ncbi-rss2html-brief/foo/bar"));
