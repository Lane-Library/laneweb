...
//        this.controller = new HTMLBookmarkController();
...
//        this.controller.setBookmarkDAO(this.dao);
    ...
    // assertEquals(this.bookmarks, this.controller.getBookmarks(this.session,
    // this.sunetid));
    ...
    // replay(this.session, this.dao);
    // assertEquals(0, this.controller.getBookmarks(this.session,
    // this.sunetid).size());
    // verify(this.session, this.dao);
    // }
    // @Test
    ...
    // this.controller.handleAddBookmark(this.request, this.response,
    // this.bookmarks, this.sunetid);
    // verify(this.request, this.response, this.dispatcher, this.dao);
    // }
    //
    // @Test
    // public void testHandleDeleteBookmarks() throws ServletException,
    // IOException {
    ...
    // this.dispatcher.forward(this.request, this.response);
    // replay(this.request, this.response, this.dispatcher, this.dao);
    // this.controller.handleDeleteBookmarks(this.request, this.response,
    // this.bookmarks, this.sunetid, new int[]{0});
    ...
    // this.dispatcher.forward(this.request, this.response);
    // replay(this.request, this.response, this.dispatcher, this.dao);
    // this.controller.handleSaveBookmark(this.request, this.response,
    // this.bookmarks, this.sunetid, 0, "newlabel", "newurl");
