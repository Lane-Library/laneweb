...
public class LaneSearchIT {
        ...
        public void testLaneSearch20428285() throws Exception {
                ...
                this.mockMvc.perform(get("/eresources/search.html?q=20428285").servletPath("/eresources/search.html"))
                                .andExpect(xpath(
                                                "//h:li[position() = 1]//h:a[@class='primaryLink bookmarking' and contains(@href,'20428285')]",
                                                this.ns).exists())
        ...
        public void testLaneSearchaccessmedicine() throws Exception {
                ...
                this.mockMvc.perform(
                                get("/eresources/search.html?q=accessmedicine").servletPath("/eresources/search.html"))
                                .andExpect(
        ...
        public void testLaneSearchAccessSpaceMedicine() throws Exception {
                // Access Medicine
                this.mockMvc.perform(
                                get("/eresources/search.html?q=Access Medicine").servletPath("/eresources/search.html"))
                                .andExpect(
                                                xpath("//h:li[position() = 1]//h:a[@class='primaryLink bookmarking' and contains(@title,'AccessMedicine')]",
                                                                this.ns).exists());
        }
        ...
        public void testLaneSearchAnatomyImages() throws Exception {
                // anatomy images
                this.mockMvc.perform(
                                get("/eresources/search.html?q=anatomy images").servletPath("/eresources/search.html"))
                                .andExpect(xpath(
                                                "//h:li[position() <= 10]//h:a[@class='primaryLink bookmarking' and @title='e-Anatomy']",
                                                this.ns)
                                                .exists());
        }
        ...
        public void testLaneSearchAndFacetCountsMatch() throws Exception {
                MvcResult facetCountResult = this.mockMvc.perform(
                                get("/eresources/count.xml?source=all-all&q=information science")
                                                .servletPath("/eresources/count.xml"))
                                .andReturn();
        ...
        public void testLaneSearchCitationManager() throws Exception {
                ...
                this.mockMvc
                                .perform(get("/eresources/search.html?q=reference management")
        ...
        public void testLaneSearchClasses() throws Exception {
                // Classes
                this.mockMvc.perform(
                                get("/eresources/search.html?q=lane classes").servletPath("/eresources/search.html"))
                                .andExpect(xpath(
        ...
        public void testLaneSearchDirections() throws Exception {
                // directions
                this.mockMvc.perform(get("/eresources/search.html?q=directions to lane")
                                .servletPath("/eresources/search.html"))
                                .andExpect(xpath(
        ...
        public void testLaneSearchEndNote() throws Exception {
                ...
                this.mockMvc.perform(get("/eresources/search.html?q=EndNote").servletPath("/eresources/search.html"))
                                .andExpect(xpath(
                                                "//h:li//h:a[@class='primaryLink bookmarking' and contains(@title,'EndNote')]",
                                                this.ns).exists());
        }
        ...
        public void testLaneSearchEndPages() throws Exception {
                ...
                this.mockMvc
                                .perform(get("/eresources/search.html?q=JMLA. 2010 4 98(2):171-175.")
                                                .servletPath("/eresources/search.html"))
                                .andExpect(xpath(
                                                "//h:li[position() <= 5]//h:a[@class='primaryLink bookmarking' and contains(@href,'20428285')]",
                                                this.ns).exists());
        }
        ...
        public void testLaneSearchJAMA() throws Exception {
                ...
                this.mockMvc.perform(get("/eresources/search.html?q=jama").servletPath("/eresources/search.html"))
                                .andExpect(
                                                xpath("//h:li[position() = 1]//h:a[@class='primaryLink bookmarking' and @title='JAMA']",
                                                                this.ns).exists());
        }
        ...
        public void testLaneSearchMovementDisorder() throws Exception {
                // movement disorder; test that top results include "Movement disorder" and
                // "Movement disorders" titles
        ...
        public void testLaneSearchpubmed() throws Exception {
                this.mockMvc.perform(get("/eresources/search.html?q=pubmed").servletPath("/eresources/search.html"))
                                .andExpect(
                                                xpath("//h:li[position() = 1]//h:a[@class='primaryLink bookmarking' and @title='PubMed']",
                                                                this.ns).exists());
        }
        ...
        public void testLaneSearchScience() throws Exception {
                ...
                this.mockMvc.perform(get("/eresources/search.html?q=science").servletPath("/eresources/search.html"))
                                .andExpect(
                                                xpath("//h:li[position() <= 3]//h:a[@class='primaryLink bookmarking' and @title='Science']",
                                                                this.ns).exists())
        ...
        public void testLaneSearchSplitOnNumerics() throws Exception {
                ...
                MvcResult facetCountResult = this.mockMvc
                                .perform(get("/eresources/count.xml?q=covid19").servletPath("/eresources/count.xml"))
                                .andReturn();
                String facetCount = facetCountResult.getResponse().getContentAsString()
                                .replaceFirst(".*<facet name=\"all\" hits=\"(\\d+)\"/>.*", "$1");
                ...
                this.mockMvc
                                .perform(get("/eresources/search.html?q=10.1113/jphysiol.1972.sp009847")
                                                .servletPath("/eresources/search.html"))
                                .andExpect(xpath(
                                                "//h:li[position() <= 5]//h:a[@class='primaryLink bookmarking' and contains(@href,'5039275')]",
                                                this.ns).exists());
        }
        ...
        public void testLaneSearchUpdashTodashDate() throws Exception {
                this.mockMvc.perform(get("/eresources/search.html?q=Up-To-Date").servletPath("/eresources/search.html"))
                                .andExpect(xpath(
                                                "//h:li[position() = 1]//h:a[@class='primaryLink bookmarking' and @title='UpToDate']",
                                                this.ns)
                                                .exists());
        }
        ...
        public void testLaneSearchUSMLEEtc() throws Exception {
                // usmle OR nbme OR "examination questions"; limited to Lane Catalog and Book
                // Digital
                this.mockMvc.perform(get(
                                ...
                                .servletPath("/eresources/search.html"))
                                .andExpect(xpath("//h:li[position() = 1]//h:span[@class='primaryType']", this.ns)
                                                .string("Book"))
                                .andExpect(xpath(
                                                "//h:li[position() <= 3]//h:a[@class='primaryLink bookmarking' and contains(@title,'USMLE')]",
                                                this.ns).exists());
        }
}
