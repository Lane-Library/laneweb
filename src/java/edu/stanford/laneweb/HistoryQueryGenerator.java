...
public class HistoryQueryGenerator extends AbstractGenerator {
	...
	private static final String COUNT_QUERY =
		...
		"UNION\n"+
		"SELECT COUNT(*) AS HITS, 'article' AS GENRE FROM HISTORY_ERESOURCE, HISTORY_TYPE\n"+
		"WHERE CONTAINS(HISTORY_ERESOURCE.TEXT,'XX ') > 0 \n"+
		"AND HISTORY_TYPE.ERESOURCE_ID = HISTORY_ERESOURCE.ERESOURCE_ID AND TYPE = 'article'\n"+
		"UNION\n"+
		"SELECT COUNT(*) AS HITS, 'chapter' AS GENRE FROM HISTORY_ERESOURCE, HISTORY_TYPE\n"+
		"WHERE CONTAINS(HISTORY_ERESOURCE.TEXT,'XX ') > 0 \n"+
		"AND HISTORY_TYPE.ERESOURCE_ID = HISTORY_ERESOURCE.ERESOURCE_ID AND TYPE = 'chapter'\n"+
		"UNION\n"+
