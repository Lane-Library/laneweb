...
public class LanewebInputModule extends AbstractLogEnabled implements
    ...
    protected String getAffiliation(final String ip) {
        ...
        if (d[0] == 10) {
            if (d[1] == 252) {
                if (d[2] == 6 || d[2] == 7 || d[2] == 10 || d[2] == 11  || d[2] == 14
                        || d[2] == 15 || d[2] == 18 || d[2] == 19 || d[2] == 22 || d[2] == 23
                        || d[2] == 26 || d[2] == 27 || d[2] == 30 || d[2] == 31 || d[2] == 34
                        || d[2] == 35 || d[2] == 38 || d[2] == 39 || d[2] == 43 || d[2] == 46
                        || d[2] == 47 || d[2] == 50 || d[2] == 51 || d[2] == 54 || d[2] == 55
                        || d[2] == 67 || d[2] == 71 || d[2] == 97 || d[2] == 108 || d[2] == 109
                        || d[2] == 122 || d[2] == 123) {
                    return LPCH;
                }
                if (d[2] >=138 && d[2] <= 146) {
        ...
        if (d[0] == 171) {
            ...
            if (d[1] == 65) {
                ...
                if (d[2] == 82) {
                    if (d[3] == 12 || d[3] == 14 || d[3] == 15 || d[3] == 25  || d[3] == 26
                            || d[3] == 30 || d[3] == 33 || d[3] == 35 || d[3] == 36 || d[3] == 37
                            || d[3] == 41 || d[3] == 42 || d[3] == 51 || d[3] == 53 || d[3] == 54
                            || d[3] == 55 || d[3] == 56 || d[3] == 58 || d[3] == 59 || d[3] == 61
                            || d[3] == 62 || d[3] == 66 || d[3] == 71 || d[3] == 76 || d[3] == 79
                            || d[3] == 81 || d[3] == 83 || d[3] == 84 || d[3] == 85 || d[3] == 86
                            || d[3] == 94 || d[3] == 104 || d[3] == 105 || d[3] == 108 || d[3] == 109
                            || d[3] == 110 || d[3] == 115 || d[3] == 119 || d[3] == 124 || d[3] == 125
                            || d[3] == 129 || d[3] == 130 || d[3] == 133 || d[3] == 135 || d[3] == 139
                            || d[3] == 141 || d[3] == 143 || d[3] == 144 || d[3] == 145 || d[3] == 146
                            || d[3] == 149 || d[3] == 180 || d[3] == 182 || d[3] == 187 || d[3] == 197
                            || d[3] == 204 || d[3] == 219 || d[3] == 231 || d[3] == 246 || d[3] == 247
                            || d[3] == 248 || d[3] == 249) {
                        return STAFF;
                    }
                    return SOM;
                ...
                if (d[2] == 83) {
                    if (d[3] == 3 || d[3] == 8 || d[3] == 82 || d[3] == 137 || d[3] == 138 || d[3] == 181
                            || d[3] == 189) {
                        return STAFF;
                    }
                    return SOM;
