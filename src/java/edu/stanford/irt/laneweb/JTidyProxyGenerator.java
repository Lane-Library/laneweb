...
public class JTidyProxyGenerator extends WebServiceProxyGenerator {
    ...
    public void generate() throws IOException, SAXException, ProcessingException {
        ...
        // throw new ProcessingException("JTidyProxyGenerator.generate() error",
        // ex);
        // } finally {
    ...
    public byte[] fetch() throws ProcessingException {
        ...
        byte[] response = null;
        try {
            int httpStatus = this.httpClient.executeMethod(method);
            ...
            if (httpStatus < 400) {
                ...
                throw new ProcessingException("The remote returned error " + httpStatus + " when attempting to access remote URL:"
                        + method.getURI());
            }
            ...
            /*
             * It is important to always read the entire response and release
             * the connection regardless of whether the server returned an error
             * or not.
